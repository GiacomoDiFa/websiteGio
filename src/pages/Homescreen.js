...
function Homescreen() {
    return (
        <>
            <div className='section'>
                <div className='container pt-5' data-aos="fade-up"data-aos-delay="500"
    data-aos-duration="1000">
            ...
            <div className='section vh-100'>
                <div className='container mb-5 mb-sm-3 mt-5' data-aos="fade-right"data-aos-delay="500"
    data-aos-duration="1000">
                    <div className='row no-gutters' data-aos="fade-right"data-aos-delay="500"
    data-aos-duration="1000">
                        <div className='col-lg-6 col-12'data-aos="fade-right"data-aos-delay="500"
    data-aos-duration="1000">
                            <h1>Condizioni di cui mi occupo</h1>
                        </div>
                        <div className='col-lg-6 col-12 pt-3 pt-lg-0'data-aos="fade-right"data-aos-delay="500"
    data-aos-duration="1000">
                            <button className='btn btn-primary float-lg-end float-xs-start'>Contattami</button>
                        </div>
                    </div>
                </div>
                <div className='container h-50 mt-5' data-aos="fade-right"data-aos-delay="500"
    data-aos-duration="1000">
    ...
    data-aos-duration="1000">
            ...
            <div className='container h-75'data-aos="fade-right"data-aos-delay="500"
    data-aos-duration="1000">
                <div className='row h-100'>
                    <div className='col-lg-6 col-12 h-100 mt-5 mt-lg-0'data-aos="fade-right"data-aos-delay="500"
    data-aos-duration="1000">
                        <Cardimage />
                    </div>
                    <div className='col-lg-6 col-12 h-100'data-aos="fade-right"data-aos-delay="500"
    data-aos-duration="1000">
                        <Cardimage />
                    </div>
                </div>
            ...
            <div className='section vh-100'>
                <div className='container pt-5'data-aos="fade-right"data-aos-delay="500"
    data-aos-duration="1000">
                    <div className='row'>
